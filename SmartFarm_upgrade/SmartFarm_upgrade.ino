/*저는 현재 다음과 같은 작업을 완료했습니다:

SHT40 센서를 이용해 주변의 온도와 습도를 측정하고,
DS18B20 센서를 통해 토양의 온도를 측정하며,
BH1750 센서를 사용하여 조도를 측정하고,
B129 센서로 토양 습도를 측정하고 있습니다.
측정된 각 센서의 값은 3초마다 한 번씩 순차적으로 OLED 디스플레이에 표시됩니다.
또한, 펌프와 미스트 분사기(안개 분무기)와의 연동도 완료되었습니다.
자동 제어 기능은 다음과 같습니다:

토양 습도가 너무 낮을 경우, 펌프가 자동으로 작동하여 식물에 물을 줍니다.
주변 온도가 30도 이상이고 습도가 너무 낮을 경우, 미스트 분사기가 자동으로 작동하여 주변 온도를 낮추고 습도를 올립니다.
*/
